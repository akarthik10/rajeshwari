...
'htmlOptions'=>array('enctype'=>'multipart/form-data'),
    ...
    <div class="formCon">
        <div class="formConInner">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                <td valign="bottom" width="33%"><?php echo $form->labelEx($model,Yii::t('students','first_name')); ?></td>
                <td>&nbsp;</td>
                <td valign="bottom" width="33%"><?php echo $form->labelEx($model,Yii::t('students','middle_name')); ?></td>
                <td>&nbsp;</td>
                <td valign="bottom" width="33%"><?php echo $form->labelEx($model,Yii::t('students','last_name')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        'style'=>'width:140px;','empty'=>'Select Nationality', 'options' => array('76'=>array('selected'=>true))
                        )); ?>
    ...
    <div class="formCon" >
        <div class="formConInner">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="bottom" width="33%"><?php echo $form->labelEx($model,Yii::t('students','address_line1')); ?></td>
                    <td>&nbsp;</td>
                    <td valign="bottom" width="33%"><?php echo $form->labelEx($model,Yii::t('students','address_line2')); ?></td>
                    <td>&nbsp;</td>
                    <td valign="bottom" width="33%"><?php echo $form->labelEx($model,Yii::t('students','city')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top">
                    	...
                    	?>
						<?php echo $form->textField($model,'state',array('size'=>25,'maxlength'=>255, 'value' => $model->state)); ?>
						<!--<select name="Students[state]">
                    ...
                    <td valign="top">
                        ...
                        'style'=>'width:140px;','empty'=>'Select Country', 'options' => array('76'=>array('selected'=>true))
                        )); ?>
