                        ...
                        <div class="filterbxcntnt_inner" style="border-bottom:#ddd solid 1px;">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div id="name" style="display:none; width:202px; padding-top:0px; height:33px" class="drop" >
                                ...
                                <li>
                                    ...
                                    <div id="admissionnumber" style="display:none;width:202px; padding-top:0px; height:33px" class="drop">
                                        <div class="droparrow" style="left:10px;"></div>
                                ...
                                <li>
                                    ...
                                    <div id="batch" style="display:none; color:#000; width:508px; height:33px; padding-left:10px; padding-top:0px; left:-200px" class="drop">
                                ...
                                <li>
                                    ...
                                    <div id="gender" style="display:none; width:243px; padding-top:0px; height:33px" class="drop">
                                        <div class="droparrow" style="left:10px;"></div>
                                        <?php
                                ...
                                <li>
                                    ...
                                    <div id="bloodgroup" style="display:none;width:243px; padding-top:0px; height:33px" class="drop" >
                                        <div class="droparrow" style="left:10px;"></div>
                                ...
                                <li>
                                    ...
                                    <div id="nationality" style="display:none;width:243px; padding-top:0px; left:-180px; height:33px;" class="drop">
                                ...
                                <li>
                                    ...
                                    <div id="dob" style="display:none; width:391px; left:-273px; height:33px; padding-top:0px;" class="drop">
                                        <div class="droparrow" style=" left:305px"></div>
                                ...
                                <li>
                                    ...
                                    <div id="admission" style="display:none;width:391px; left:-190px;  height:33px; padding-top:0px;" class="drop">
                                        <div class="droparrow" style=" left:200px"></div>
                                ...
                                <div onClick="hide('status')" style="cursor:pointer;"><?php echo Yii::t('students','Status');?></div>
                                    <div id="status" style="display:none; width:243px; min-height:33px; left:-120px; padding-top:0px;" class="drop">
