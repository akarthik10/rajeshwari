...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><?php 
		...
		//echo CHtml::dropDownlist('attentance','',array('Daily'=>'Daily','SubjectWise'=>'SubjectWise'),array('options'=>array($val_4->config_value=>array('selected'=>true)))); 
		echo CHtml::dropDownlist('attentance','',array('Daily'=>'Daily'),array('options'=>array($val_4->config_value=>array('selected'=>true))));?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
   ...
   else
   {
    ...
    <td><?php echo Yii::t('settings','Currency Type').'<br/>'.Yii::t('settings','( Symbols/short forms )');?></td>
    <td> <?php 
...
if(count($img)!=0)
{
	...
	foreach($img as $img_1)
	{
		...
		echo '<img class="imgbrder" src="uploadedfiles/school_logo/'.$img_1->photo_file_name.'" alt="'.$img_1->photo_file_name.'" width="100" height="100" />'; 
...
<br />
	<div class="row">
		...
		echo CHtml::checkBox('employee_number',array('checked'=>'checked')); ?>
         <?php echo Yii::t('settings','Enable Auto increment Employee no.');?><?php */?>
